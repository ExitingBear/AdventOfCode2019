...
input<-read_lines("../../AoCData/AOC2019/Day14.txt")
```

## Part 1
This is recursive.

I think I'm going to do an unholy combination of a about 6 different things... I am building a map so that I can roll up by "distance to ore" & a transform list.  Also, I hate this solution - it's way too scattered
```{r}
