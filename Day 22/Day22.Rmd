...
```{r}
modtransform(119315717514047,input)
```
A=28480444974763
B=104343029082553
...
```{r}
### A
modinv(28480444974763,119315717514047)
### B
(modinv(28480444974763,119315717514047)*-104343029082553)%%119315717514047

```
And run that through multishuffle:

```{r}
multishuffle(82675948719931,791884595200,101741582076661,119315717514047,2020)
```
...
On the really big deck:
```{r}
inverstrans(119315717514047,rev(input))
```
Those are different numbers than above, but maybe they'll work.

run through multishuffle: 

```{r}
multishuffle(43018258219008,33143725761322,101741582076661,119315717514047,2020)
```
